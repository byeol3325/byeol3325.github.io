...
export const projects = [
    ...
    },
    {
        ...
        goal: '** TODO: Please fill in the project goal. **',
        role: 'Core Developer (40% contribution) - Optimization through Multi-Threading and data structure improvements.',
        achievement: 'Improved speed by up to 60% compared to the existing algorithm without performance degradation.',
        blogUrl: null,
    },
    {
        title: '** TODO: Project Name **',
        ...
        goal: '** TODO: Please fill in the project goal. **',
        role: 'Core Developer (40% contribution) - Developed a camera calibration module using a circular grid chessboard.',
        achievement: 'Developed a camera calibration module using a circular chessboard with an accuracy of ** TODO: specify accuracy **.',
        blogUrl: null,
    },
    {
        title: 'Pill Detection and Recognition',
        company: 'ETRI',
        date: 'Sep 2024 - Dec 2024',
        goal: '** TODO: Please fill in the project goal. **',
        role: 'Lead Researcher (80% contribution) - Developed an algorithm to detect and identify pills without additional 2D pill detection training (using Template matching, color consideration, warping, etc.).',
        achievement: '** TODO: Please fill in the achievement. **',
        blogUrl: null,
    },
];
